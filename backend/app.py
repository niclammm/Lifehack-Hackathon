    ...
    try:
        ...
        if 'interactions' in data and data['interactions']:
            ...
            header_fixes = {
                ...
                'Purchase Count': InteractionHeaders.PURCHASES,
            ...
            print("Headers after fix:", interactions_df.columns.tolist())
            ...
            print("Final headers after auto-creation:", interactions_df.columns.tolist())
        ...
        print("Data upload successful. Processing interactions...")
        
        # Call the train_model function from train_lightfm.py
        recommended_rewards = train_model(interactions_df, customers_df, products_df, num_of_rewards)
        
        print("Model training and recommendation generation complete.")
        # Calculate analytics after upload
        # analytics = calculate_basic_analytics()
        
        print(f"Recommended rewards: {recommended_rewards}")
